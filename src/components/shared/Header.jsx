...
const Header = () => {
  return (
    <header className="w-full bg-card-gray ">
      <div className="comp-header w-full text-white fixed top-0 flex h-16 z-50 px-4 flex justify-between container mx-auto">
